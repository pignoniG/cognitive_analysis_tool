...
def lumAnalysis(self):
    ...
    if useCamera:
        distanceVal, distanceTime = drawDistance(self.plotDist,
                                                 recPupilValues_filter_scaled_Lum,
                                                 spotPupilValues,
                                                 recSimpleTimeStamps,
                                                 distSampleLenght,
    ...
    self.plotDist.title(f"CW{recording_name}")
    if showPlot:
        self.plotDist.savefig(join(export_source, f'plot{recording_name}.pdf'),
                              bbox_inches='tight')
        self.plotDist.savefig(join(export_source_alt, f'plot_{recording_name}.pdf'),
                              bbox_inches='tight')
